...
/**
 * This example is taken from the github repo, works without any modifications - https://github.com/jkristell/infrared/blob/master/examples/arduino_uno/src/bin/polled.rs
